...
class BaseTrainer:
    def __init__(self, model: 'WildfireModel', optimizer: torch.optim.Optimizer = None,
        ...
        self.update_steps_first = 2
        self.update_steps_last = 6
    ...
    def criterion(inputs: torch.Tensor, target: torch.Tensor):
        ...
        conv = nn.Conv2d(1, 1, kernel_size=window_size, stride=stride, bias=False)
        ...
        for epoch in range(self.max_epoch):
            ...
            for iterations in range(max_iterations):
                ...
                print(
                    ...
                    f"Loss: {running_loss / max_iterations}"
                )
